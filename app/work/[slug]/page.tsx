...
// Navbar y layout viene del app/layout.tsx — no se importa acá para evitar
// que se renderice 2 veces.
...
// ============================================================
// Página principal — recibe slug y renderiza el detalle
// ============================================================
    ...
    <>
      ...
      <main className="project-detail">
        <article className="project-detail-container">
          ...
          {project.intro && <ProjectIntro intro={project.intro} />}
