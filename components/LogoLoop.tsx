...
const useResizeObserver = (
  callback: () => void,
  // RefObject<T | null> es lo que devuelve useRef en React 19+ — no
  // RefObject<T>. Aceptamos el null aquí para no tener que castear en
  // el call-site.
...
/**
 * Logo loop slider — track horizontal o vertical con autoplay infinito,
 * smooth velocity easing, fade en bordes, pause on hover. Soporta nodos
 * React (via .node) o imágenes (.src), o custom renderItem.
 *
...
export const LogoLoop = memo(function LogoLoop({
  ...
  useResizeObserver(
    updateDimensions,
    [containerRef, seqRef as React.RefObject<HTMLElement>],
